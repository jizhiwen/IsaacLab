...
from isaaclab_tasks.manager_based.manipulation.stack.config.franka.pick_place_ik_pos_inference_env_cfg import FrankaCubeInferencePickPlaceBlueprintEnvCfg


def main():
    """Main function."""
    # setup environment
    env_cfg = FrankaCubeInferencePickPlaceBlueprintEnvCfg()
    ...
    with torch.inference_mode():
        while simulation_app.is_running():
            ...
            for i in range(0, len(single_arm)):
                grapper_closed = False if gripper[i] > 100 else True
