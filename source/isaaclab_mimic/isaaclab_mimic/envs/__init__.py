...
from .franka_pick_place_ik_rel_blueprint_mimic_env_cfg import FrankaCubePickPlaceIKRelBlueprintMimicEnvCfg
...
gym.register(
    id="Isaac-Pick-Place-Cube-Franka-IK-Rel-Blueprint-Mimic-v0",
    entry_point="isaaclab_mimic.envs:FrankaCubeStackIKRelMimicEnv",
    kwargs={
        "env_cfg_entry_point": franka_pick_place_ik_rel_blueprint_mimic_env_cfg.FrankaCubePickPlaceIKRelBlueprintMimicEnvCfg,
    },
    disable_env_checker=True,
)